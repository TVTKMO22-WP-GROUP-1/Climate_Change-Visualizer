    ...
    const HandledeleteSubmit = async (event) => {
        ...
        // API call
           ...
           /* // Simple DELETE request with axios
            axios.delete(Constants.API_ADDRESS + '/delete')
                axios.then(() => this.setState({ status: 'Delete successful' })),
        ...
        try {
            const result = await axios.delete(Constants.API_ADDRESS + '/deleteuser',
            {
